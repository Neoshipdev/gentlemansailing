...
(function () {
  ...
  var DICT = {
    ...
    i_b03a: { sk: "Aspoň jeden člen posádky musí predložiť pri registrácii platnú kvalifikáciu potrebnú pre plavbu na námornej plachetnici v oblasti Jadranu a aspoň jeden člen posádky musí vlastniť osvedčenie SRC, alebo rádiotelefonista plavebnej pohyblivej služby platnej v oblasti Jadranu.", en: "At registration, at least one crew member must present a valid qualification for sailing a seagoing yacht in the Adriatic, and at least one crew member must hold an SRC certificate or a maritime mobile service radio operator licence valid for the Adriatic." },
    i_b03b: { sk: "Posádky s loďami, ktoré sú spôsobilé na účasť, sa môžu prihlásiť do 31. marca 2027. Do tohto termínu musí byť taktiež uhradené štartovné v plnej sume. Kontaktnou osobou je Peter Piala, info@gentlemansailing.sk.", en: "Crews with eligible boats may enter until 31 March 2027. The entry fee must also be paid in full by this date. The contact person is Peter Piala, info@gentlemansailing.sk." },
    i_b05a: { sk: "Žrebovanie lodí sa uskutoční 4 týždne pred regatou, miesto a čas budú upresnené.", en: "The boat draw will take place 4 weeks before the regatta; the place and time will be announced." },
    i_b05b: { sk: "Prevzatie lodí sa podľa rozpisu zo žrebovania uskutoční deň pred štartom regaty od 15:00 h v Marine Hramina.", en: "Boat handover, according to the draw schedule, takes place the day before the start of the regatta from 3 p.m. at Marina Hramina." },
    i_b05c: { sk: "Predpokladaný počet rozplavieb: 5.", en: "Expected number of races: 5." },
