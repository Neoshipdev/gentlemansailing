...
(function () {
  ...
  var DICT = {
    ...
    intro_body: { sk: 'Gentleman Sailing je regata s 20-ročnou tradíciou, ktorá v minulosti niesla názvy IT Regata Open, či neskôr Trend Regata. Od roku 2011 sa plavíme pod názvom Gentleman Sailing, a po úspešných predošlých, nás teraz čaká už 21. ročník.', en: 'Gentleman Sailing is a regatta with a 20-year tradition, formerly known as IT Regata Open and later Trend Regata. Since 2011 we have sailed under the Gentleman Sailing name, and after many successful editions the 21st now awaits us.' },
    ...
    price_includes_body: { sk: 'Prenájom lode vrátane dokladov, prístavné poplatky, upratovanie lode, slávnostné otvorenie a vyhodnotenie regaty spojené so spoločnými večerami pre celú posádku s limitovanými nápojmi, podporné plavidlá, rozhodcovskú loď s rozhodcom i celým podporným tímom, tričká, trofeje, pobytovú taxu, označenie lodí firemnými logami.', en: 'Yacht rental including documents, port fees, boat cleaning, the opening and closing ceremonies of the regatta with shared dinners for the whole crew including limited drinks, support vessels, the committee boat with the race officer and the whole support team, t-shirts, trophies, tourist tax and branding of the boats with company logos.' },
    price_iban_note: { sk: 'Prvú časť štartovného je potrebné uhradiť najneskôr do 7 dní od potvrdenia účasti.', en: 'The first part of the entry fee must be paid within 7 days of confirmation of participation.' },
